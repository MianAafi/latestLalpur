  ...
  return (
    <Layout title={"Lyallpur Collection "}>
      ...
      <div className="container-fluid row home-page">
        <div className="col-md-3 filters Filters-div">
          <h4 className="text-left catagory-heading"> Filter By Categories</h4>
          {/* <FaGripLines style={{ color: "black" }} /> */}
          <div className="d-flex flex-column">
            {categories?.map((c) => (
              ...
              >
                <span className="catagori-span"> {c.name}</span>
              </Checkbox>
            ))}
          </div>
          {/* price filter */}
          ...
          <div className="d-flex flex-column">
            <Radio.Group onChange={(e) => setRadio(e.target.value)}>
              {Prices?.map((p) => (
                <div key={p._id}>
                  <Radio value={p.array}>
                    <span className="catagori-span">{p.name}</span>
                  </Radio>
                </div>
              ))}
            </Radio.Group>
        ...
        <div className="col-md-9" style={{ marginTop: "5rem" }}>
          ...
          <div className="d-flex flex-wrap">
            {products?.map((p) => (
              <div
                id="Product-item"
                className="card m-2 bg-transparent"
                key={p._id}
              >
                <img
